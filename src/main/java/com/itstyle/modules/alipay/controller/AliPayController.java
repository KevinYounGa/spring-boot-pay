...
import com.itstyle.dao.OrderInfoMapper;
import com.itstyle.model.OrderInfo;
...
public class AliPayController {
    ...
    public String  pcPay(Product product,ModelMap map) {
		...
		order.setOrderName(product.getSubject());
		order.setTotalFee(product.getTotalFee());
		order.setOutTradeNo(product.getOutTradeNo());
		order.setCreateDate(DateUtil.getTime());
		order.setUpdateDate(DateUtil.getTime());
